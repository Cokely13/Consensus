...
//       if (yesterdayQuestion) {
//         setSelectedQuestion(yesterdayQuestion); // Set yesterday's question as the selected question
...
//           <PieChart
//             data={chartData}
//             questionText={`Yesterday's Question: ${selectedQuestion.text}`}
//             optionALabel={selectedQuestion.optionA}
//             optionBLabel={selectedQuestion.optionB}
//           />
//         </div>
...
//         </div>
//       ) : (
//         <div>{questions.length > 0 ? 'No question for yesterday.' : 'Loading questions...'}</div>
//       )}
//     </div>
//   );
// }
  ...
  useEffect(() => {
    if (questions.length > 0 && user.user_responses) {
      ...
      if (yQuestion) {
        ...
        if (yQuestion.consensus.length > 0) {
