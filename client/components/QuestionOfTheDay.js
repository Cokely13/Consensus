...
//   //   if (!selectedQuestion || !selectedQuestion.user_responses) {
//   //     return { percentageA: 0, percentageB: 0, percentageNoVote: 0 };
//   //   }

//   //   const votesA = selectedQuestion.user_responses.filter(
//   //     (response) => response.response === 'option_a'
//   //   ).length;

//   //   const votesB = selectedQuestion.user_responses.filter(
...
//   const calculateChartData = () => {
//     // Ensure selectedQuestion and its user_responses are defined
//     if (!selectedQuestion || !selectedQuestion.user_responses) {
//       return { percentageA: 0, percentageB: 0, percentageNoVote: 0 };
//     }

//     console.log("selected", selectedQuestion)
//     console.log("user", selectedQuestion.user_responses)

//     // Ensure users array is defined
...
//     console.log("votes", votesB)

//     // Total votes and total users
//     const totalVotes = votesA + votesB;
//     const totalUsers = users.length;
//     const noVotes = totalUsers - totalVotes;
...
//         {/* Contain the PieChart in a fixed-width container */}
//         <PieChart
//             data={chartData}
//             questionText={`Question of the Day: ${selectedQuestion.text}`}
//             optionALabel={selectedQuestion.optionA}
//             optionBLabel={selectedQuestion.optionB}
//           />
//       </div>)}
...
//     console.log("votes", { votesA, votesB, noVotes });
